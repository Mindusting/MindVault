...
> YouTube:
> - [Spanning Tree](https://youtu.be/K1a2Bk8NrYQ) #WWW/YT/SpanningTree

Un árbol binario es similar a las [listas](pc_ds_list.md) en el sentido de que sirven para guardar valores, pero su comportamiento cambia bastante.

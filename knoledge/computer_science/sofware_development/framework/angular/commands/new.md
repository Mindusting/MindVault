---
aliases: [Comando new en Angular, Crea un nuevo proyecto en Angular]
author: Mindusting
corrected: false
headerFile: false
tags:
...
Este hará que se puede ver nuestra página en local, para ello, usaremos un buscador de internet y buscaremos la [URL](../../../../../../dump/urx.md) `http://localhost:4200`.

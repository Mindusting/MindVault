...
> [!faq]- FAQ
> - [¿Qué es un diagrama de flujo?](../../programming/design/design_flowchart.md)

Para indicarle a [**Mermaid**](mermaid.md) que queremos hacer un **diagrama de flujo** el encabezado debe ser `flowchart`; hace falta indicar más cosas que iremos viendo más adelante; de momento te dejo un ejemplo simple para que veas qué cosas se pueden hacer.

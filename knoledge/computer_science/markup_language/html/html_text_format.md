...
> > [!todo] #TODO
> > - [ ] Documentar la etiqueta `abbr`.

## PÁRRAFOS

> [!help]- REFERENCIAS WEB
> - [W3 Schools](https://www.w3schools.com/html/html_paragraphs.asp) #WWW/W3Schools
...
> Esta etiqueta se usaba en **HTML4** para hacer el texto grande, en **HTML5** se usa [CSS](../../style_language/css/css.md) para hacer el texto más grande.

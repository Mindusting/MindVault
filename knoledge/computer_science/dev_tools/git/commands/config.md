...
# COMANDO CONFIG EN GIT

> [!unfinished-file]- ESTE APARTADO ESTÁ INCOMPLETO
> > [!todo] #TODO

> [!external-link]- REFERENCIAS WEB
> - [Git](https://git-scm.com/docs/git-config) #WWW/Git
...
Si es la primera vez que creamos un [repositorio](init.md) en el equipo, para cambiar la configuración ==dentro de nuestro usuarios del sistema== se hace siguiendo la siguiente sintaxis:
...
- `--local`: (*Opción por defecto estando dentro de un [repositorio](init.md)*) Se guarda en el archivo `./.git/config` (*siendo este el [repositorio](init.md) de git*), se aplica a el [repositorio](init.md).
...
> 
> Por lo que si ponemos un nombre de usuario en `--gloval` y luego ponemos otro en `--local`, se aplicará el que se encuentre en `--local`, ya que es el que se encuentra más cerca al [repositorio](init.md).

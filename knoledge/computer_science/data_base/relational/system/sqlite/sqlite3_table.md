...
> - [SQLite](https://sqlite.org/lang_createtable.html) #WWW/SQLite
> 
> YouTube:
> - [Aaron Francis](https://youtu.be/sgVpOaJLoG0) #WWW/YT/AaronFrancis

> [!faq]- FAQ
> - [¿Qué son las tablas en SQL?](../../query_language/sql_table.md)
...
Para crear una [tablas](../../query_language/sql_table.md) básica en SQLite con la que podremos guardar datos de usuarios, podremos seguir el siguiente ejemplo.

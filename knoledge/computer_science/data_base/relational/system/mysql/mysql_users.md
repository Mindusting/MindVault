...
> [!faq]- FAQ
> - [¿Qué son los usuarios en SQL?](../../query_language/sql_users.md)
...
Los **usuarios** en **MySQL** se guardan dentro de una [base de datos](../../theory/db.md) llamada `mysql`, esta contiene una [tabla](../../query_language/sql_table.md) llamada `user` con todos los usuarios registrados y sus permisos.

Para poder ver el esquema de la [tabla](../../query_language/sql_table.md) de **usuarios** tendremos que ejecutar las siguientes instrucciones:

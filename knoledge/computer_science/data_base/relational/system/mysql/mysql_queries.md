...
Las consultas en [SQL](../../query_language/sql.md) sirven para obtener información de la **tablas**, para poder hacer la consulta más básica tendremos que usar las palabras clave `SELEC` y `FROM`.

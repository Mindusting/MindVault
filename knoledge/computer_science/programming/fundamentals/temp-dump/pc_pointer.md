...
> > [!todo] #TODO
> > - [ ] Rehacer por completo toda la documentación (*no me ha gustado nada como ha quedado*); hacer dos apartados, uno simple para entender de fora medianamente abstracta cono funcionan, y otro en el que se explique a bajo nivel como funcionan.
> > - [ ] Explicar los punteros genéricos.

> [!external-link]- REFERENCIAS WEB
> YouTube:
> - [Jordan West](https://youtu.be/ZNjg_7nxsz4) #WWW/YT/JordanWest
...
> [!note] Nota
> Si has terminado de entender el funcionamiento de los punteros te recomiendo que vayas al apartado de [arrays en la programación](data_structures/pc_ds_array.md) para que puedas ver uno de los usos más comunes que se le puede dar a un **puntero**.

...
> [!example] EJEMPLO
> Imaginemos que tenemos un texto y por cuestión de anonimato queremos censurar los coreos electrónicos de la gente que aparece involucrada.
...
patter: str = r"\w+@\w+.\w+"
repl: str = "[EMAIL]"
text: str = "Los usuarios adelio@email.com y adelia@email.com son los sugetos de prueba."
...
#SALIDA:
# Los usuarios [EMAIL] y [EMAIL] son los sugetos de prueba.
```

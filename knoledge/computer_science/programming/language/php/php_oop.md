...
> Antes de empezar a leer esta documentación, recomiendo que tengas a mano la documentación a cerca de la [OOP (*Object Oriented Programmin*)](../../fundamentals/basics/oop.md); ya que es la parte teórica y general de este apartado, en el que se va a ver la [OOP](../../fundamentals/basics/oop.md) concretamente de [**PHP**](php.md).

...
> [!abstract] SINTAXIS
> <span class="italic"><span class="key-word-color">[accessMod] {static} [typeReturn]</span> <span class="function-color">[methodName]</span></span>(<span class="italic grey">[args]</span>) {<span class="italic grey">[codeOfMethod]</span>}
...
Si quieres más información al respecto consulta la documentación de las [clases en java](basics/oop.md), concretamente el apartado del [`static`](basics/oop.md#PROPIEDAD%20STATIC).

...
> Cabe resaltar que esta [clase](../../basics/oop.md) (`JsonArray`) hereda de la [clase](../../basics/oop.md) [`JsonElement`](java_gson_jsonelement.md), por lo que además de los [métodos](../../java_method.md) que se documentan en este apartado, también contienen los de [`JsonElement`](java_gson_jsonelement.md).

Los [*arrays*](../../basics/arrays.md) en [**JSON**](../../../../data_format/json.md) son más flexibles que los [*arrays*](../../basics/arrays.md) en **Java**, ya que estos pueden contener valores de **distintos tipos**, por lo que al tratar con la información contenida dentro de estos, tendremos que ir especificando de qué forma interpretar la información guardada en su interior.

---

Aquí tienes un resumen de los [métodos](../../java_method.md) que contiene esta [**clase**](../../basics/oop.md):
...
En el `JsonArray` no se puede meter cualquier tipo de elemento como puede ocurrir en los [*array*](../../basics/arrays.md) de **Java**, sino que solo se pueden guardar unos tipos en concreto:
...
Para poder hacer una [**copia profunda**](../../../../fundamentals/temp-dump/pc_deepcopy.md) de un `JsonArray` se usa el [método](../../java_method.md) `deepCopy`; este no recibe ningún argumento y devuelve otro [objeto](../../basics/oop.md#OBJETOS) de tipo `JsonArray`.

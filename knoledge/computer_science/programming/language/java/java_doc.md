...
Para crear la documentación, tenemos que crear un [comentario multilínea](basics/comments.md) encima de las [funciones/métodos](java_method.md) o [clases](basics/oop.md):

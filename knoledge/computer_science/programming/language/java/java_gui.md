...
> - [geeksforgeeks](https://www.geeksforgeeks.org/java-jframe) #WWW/geeksforgeeks

- [Swing](packages/javax/swing/java_swing.md)

%%
Para crear un entorno gráfico usamos las librerías `javax.swing` y `java.awt`, dentro de estas podemos encontrar las [clases](basics/oop.md) necesarias para trabajar con entornos gráficos.
...
Por lo general no se suele hacer como hemos estado viendo hasta ahora en estos ejemplos, esto ha sido simplemente para ver las bases, esta forma de trabajar sobre la [clase](basics/oop.md) `JFrame` provoca que como queramos hacer algún tipo de modificación, no vamos a poder, para ello, lo que se suele hacer es crear una [clase](basics/oop.md) que herede de `JFrame`, así podremos usar esta nueva [clase](basics/oop.md) al igual que `JFrame`, pero podremos modificarla a nuestro antojo.

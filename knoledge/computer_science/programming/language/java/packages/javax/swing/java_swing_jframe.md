...
La [clase](../../../basics/oop.md) `JFrame` se encuentra en el paquete `javax.swing` y es la encargada de crear la ventana, en esta configuraremos cosas como el tamaño, la posición, el título, entre otras cosas, generalmente por cuestiones de comodidad se usa la herencia para crear nuestra propia [clase](../../../basics/oop.md).
...
Dentro de esta clase podremos poner toda la configuración que queramos para nuestra ventana, una ver hayamos terminado con ella, podremos mostrar la ventana creando un [objeto](../../../basics/oop.md) de esta.
...
![#center](../../../assets/java_swing_jframe_position.excalidraw.md)
...
Para establecer un título a nuestra ventana se usa el [método](../../../java_method.md) `setTitle`, este recibe un argumento de tipo [`String`](../../java/lang/java_lang_string.md) indicando el título.
...
Para establecer una imagen como icono de la ventana primero tendremos que cargarla con la [clase](../../../basics/oop.md) `ImageIcon` la cual también se encuentra en el módulo `javax.swing`, una vez hayamos cargado imagen podremos establecerla como icono como se puede ver en el ejemplo, haciendo uso de del [método](../../../java_method.md) `setIconImage`, esta recibe un argumento de tipo `Image`.

...
> Recomiendo tener a mano los siguiente documentos para poder comprender la siguiente documentación, sobre todo si tu intención es llegar más haya de los ejemplos simples que puedes encontrar aquí, ya que los siguientes documentos entran más en detalle sobre cada [clase](basics/oop.md):

...
> Un ejemplo didáctico de esto sería el siguiente caso, en el que queremos obtener el inverso de Pitágoras de un vector de tres dimensiones, en este caso tenemos dos excepciones posibles, la división entre cero y acceder a una posición del [array](basics/arrays.md) que no existe, por último, por sea caso, también controlamos cuando ocurra cualquier otra excepción.
> 
> ```java

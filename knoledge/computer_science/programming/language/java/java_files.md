...
Todos los archivos de Java deben tener una [clase](basics/oop.md) con el mismo nombre que el archivo:
...
Esta a su vez, es la única [clase](basics/oop.md) que puede tener un método `main`:

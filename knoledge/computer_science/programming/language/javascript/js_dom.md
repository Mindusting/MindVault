...
> > [!todo] #TODO
> > - [ ] Explicar como obtener elementos del documento con un [selector de CSS](../../../style_language/css/css_selectors.md).
...
- getElementsByTagName(***\[tag\]***):
    ...
    - Si no encuentra ninguno devuelve un [array](js_array.md) vacío.
- querySelector([***\[query\]***](../../../style_language/css/css_selectors.md)):
    - Devuelve el elemento que coincida con el [*selector*](../../../style_language/css/css_selectors.md) de [CSS](../../../style_language/css/css.md) indicado.
    - Si no lo encuentra devuelve `NULL`.
- querySelectorAll([***\[query\]***](../../../style_language/css/css_selectors.md)):
    - Devuelve los elementos que coincidan con el [*selector*](../../../style_language/css/css_selectors.md) de [CSS](../../../style_language/css/css.md) indicado.
    - Si no encuentra ninguno devuelve un [array](js_array.md) vacío.
[css_selectors](../../../style_language/css/css_selectors.md)
```html
<!DOCTYPE html>
<html lang="es">
<head>

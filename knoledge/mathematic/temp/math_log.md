...
> El *logaritmo natural* en algunos sitios en vez de referirse a el como "**log**" se refieren a el como "**ln**", por lo que se vas a calcular el *logaritmo* en alguna base en concreto y ves que tienes las dos opciones, a priori la correcta es "**ln**".
